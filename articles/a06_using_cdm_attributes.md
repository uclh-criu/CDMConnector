...
``` r
cdmCon(cdm)
#> <duckdb_connection 77820 driver=<duckdb_driver dbdir='/tmp/RtmpFYef13/file25326ae8b31d.duckdb' read_only=FALSE bigint=numeric>>
```
...
#> Rows: ??
#> Columns: 4
#> Database: DuckDB 1.4.4 [unknown@Linux 6.14.0-1017-azure:R 4.5.2//tmp/RtmpFYef13/file25326ae8b31d.duckdb]
